class RostersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @roster.save
        ...
        format.js { redirect_to request.original_url, notice: 'You was successfully joined.'}        
        ...
        format.js { redirect_to request.original_url notice: 'Sorry, Something wrong! Try again.'}
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      format.js { redirect_to get_token_url, notice: 'You was successfully left.'}
    end
  end
  ...
  private
    ...
    def set_roster      
      ...
      @race = Race.find(params[:roster][:race_id]) unless params[:race_id]
