...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { describe: @race.describe, end: @race.end, start: @race.start, title: @race.title }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { describe: @race.describe, end: @race.end, start: @race.start, title: @race.title }
    assert_redirected_to race_path(assigns(:race))
  end
